 ...
 *
 * <p>Provides endpoints for storing readings and retrieving the current state of a hub, identified
...
public class ExternalHubController {
  ...
  /**
   * Extract the hub ID from the request attributes, which should have been set by the API key
   * authentication filter.
   *
   * @param request The HTTP request.
   * @return The hub ID associated with the API key in the request.
   * @throws ResponseStatusException If the hub ID is not found in the request, indicating an
